...
> 6. BAGEL step execution supports image generation with the single-stage pipeline and requires `num_inference_steps >= 2`; see [Diffusion Execution Modes](diffusion/execution_modes.md#step-execution).
